...
// Connection card component - extracted to reduce complexity
function ConnectionCard({
  ...
  profile: { firstName: string; availableDates: string[] };
  userId: string;
  selectedDate: string;
  isSending: boolean;
  ...
  if (status?.status === "matched") {
    return (
      <>
        ...
        <Link href={`/messages?chat=${userId}&type=conversation`}>
