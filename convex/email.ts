    ...
    try {
      ...
      switch (args.type) {
        case 'invitationReceived':
          template = templates.invitationReceived(args.senderName, args.date || '');
          break;
        case 'invitationAccepted':
          template = templates.invitationAccepted(args.senderName, args.date || '');
          break;
        case 'invitationDeclined':
          template = templates.invitationDeclined(args.senderName, args.date || '');
          break;
        case 'newMessage':
