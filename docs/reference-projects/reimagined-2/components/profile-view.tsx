...
const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  return (
    <div className="pb-20">
      ...
      {/* Cover Photo */}
      <div className="group relative h-64 w-full bg-gray-300 md:h-80 dark:bg-gray-700">
        <img
          alt="Cover"
              ...
              {[
                ...
                <button
                  className={`flex flex-1 items-center justify-center gap-2 whitespace-nowrap border-b-2 px-6 py-4 font-bold text-sm transition-colors ${
                    activeTab === tab.id
                      ? "border-orange-500 bg-orange-50/50 text-orange-600 dark:bg-orange-500/20 dark:text-orange-400"
                ...
                >
                  ...
                  {tab.label}
                  {tab.count !== undefined && (
                    <span className="rounded-full bg-gray-200 px-2 py-0.5 text-gray-600 text-xs dark:bg-gray-700 dark:text-gray-400">
                      {tab.count}
                    </span>
                  )}
                </button>
