...
export type City = 'Vilnius' | 'Kaunas' | 'Klaipėda' | 'Šiauliai' | 'Panevėžys' | 'Other';
...
export const CITIES: City[] = ['Vilnius', 'Kaunas', 'Klaipėda', 'Šiauliai', 'Panevėžys', 'Other'];

export const LANGUAGES: Language[] = ['Lithuanian', 'English', 'Ukrainian', 'Russian'];
